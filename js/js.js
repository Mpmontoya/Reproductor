const canciones = [
    "game-of-thrones-house-baratheon-theme.mp3",
    "game-of-thrones-house-greyjoy-theme.mp3",
    "game-of-thrones-season-6-ost-the-winds-of-winter-ep-10-final-scene.mp3",
    ]
...
const updateProgress = () =>{
	if (miguel.currentTime >0){
		const barra = document.getElementById('progress')
		barra.value = (miguel.currentTime / miguel.duration) * 100
		
		var duracionSegundos= miguel.duration.toFixed(0);
		dura=secondsToString(duracionSegundos);
		var actualSegundos = miguel.currentTime.toFixed(0)
...
function adelantar(e){
	const scrubTime = (e.offsetX / progress.offsetWidth) * miguel.duration;
	miguel.currentTime = scrubTime;
	console.log(e);
}
